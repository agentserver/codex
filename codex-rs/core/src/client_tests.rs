...
async fn responses_generate_fresh_attestation_headers_for_chatgpt_codex() {
    ...
    model_client
        .extend_attestation_header_for_responses_endpoint(&mut first_headers, &provider)
        .await;
    model_client
        .extend_attestation_header_for_responses_endpoint(&mut second_headers, &provider)
        .await;
...
async fn compact_generate_fresh_attestation_headers_for_chatgpt_codex() {
    ...
    model_client
        .extend_attestation_header_for_compaction_endpoint(&mut first_headers, &provider)
        .await;
    model_client
        .extend_attestation_header_for_compaction_endpoint(&mut second_headers, &provider)
        .await;
...
async fn realtime_setup_generate_fresh_attestation_headers_for_chatgpt_codex() {
    ...
    model_client
        .extend_attestation_header_for_realtime_call_setup(&mut first_headers, &provider)
        .await;
    model_client
        .extend_attestation_header_for_realtime_call_setup(&mut second_headers, &provider)
        .await;
...
async fn non_chatgpt_codex_endpoints_omit_attestation_generation() {
    ...
    model_client
        .extend_attestation_header_for_responses_endpoint(&mut response_headers, &provider)
        .await;
    let mut compaction_headers = http::HeaderMap::new();
    model_client
        .extend_attestation_header_for_compaction_endpoint(&mut compaction_headers, &provider)
        .await;
    let mut realtime_headers = http::HeaderMap::new();
    model_client
        .extend_attestation_header_for_realtime_call_setup(&mut realtime_headers, &provider)
        .await;
